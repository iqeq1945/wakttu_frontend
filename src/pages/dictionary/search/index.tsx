...
import { processWordData, processWordsData } from "@/utils/processWordData";
...
const Search: React.FC<SearchProps> = ({ words }) => {
  ...
  return (
    <Container >
      <Header />
      <SearchSection keyword={finalKeyword} words={words} />
    </Container>
  );
};
  ...
  const words_: Words_ = [
    {
      ...
      "meta": {
        ...
        "url": [
          "https://youtu.be/dWrwEUqHJXU?si=DrHwYEC5wlMDzVj8"
        ],
        "bgm": "v-21"
      },
      "hit": 0,
